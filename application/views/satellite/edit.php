...
<table style="width:100%" class="satmodetable table table-sm table-striped">
		...
		<tbody>
			...
			<tr class="satmode_<?php echo $mode->id ?>">
				...
				<td id="editButton" style="text-align: center; vertical-align: middle;"><button id="<?php echo $mode->id ?>" class="editSatmode btn btn-sm btn-success"><i class="fas fa-edit"></i></button></td>
